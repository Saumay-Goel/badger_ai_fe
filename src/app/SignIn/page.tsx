        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-2xl shadow-2xl ring-1 ring-slate-900/5 p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="bg-white border border-slate-200 hover:border-indigo-300 hover:bg-indigo-50/50 py-3 rounded-xl font-medium transition-all hover:shadow-md flex items-center justify-center gap-2 text-slate-700"
            >
